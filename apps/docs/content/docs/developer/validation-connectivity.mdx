...
<AutoTypeTable path="../../packages/api-schemas/src/registry.ts" name="ConnectivitySpec" />

### ConnectivityCheck

<AutoTypeTable path="../../packages/api-schemas/src/registry.ts" name="ConnectivityCheck" />

### SourcePod

<AutoTypeTable path="../../packages/api-schemas/src/registry.ts" name="SourcePod" />

### TLSConfig

<AutoTypeTable path="../../packages/api-schemas/src/registry.ts" name="TLSConfig" />
