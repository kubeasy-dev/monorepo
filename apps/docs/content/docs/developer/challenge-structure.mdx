...
<AutoTypeTable path="../../packages/api-schemas/src/registry.ts" name="RegistryChallengeYaml" />
...
|------|---------------|-------------------|
| `fix` | Broken setup | Diagnose the root cause and repair it |
| `operate` | Running infrastructure | Execute a specific operational task |
| `improve` | Working but incomplete | Strengthen reliability, security, or observability |
| `migrate` | Working but outdated | Transition to a new configuration or pattern |
