...
<AutoTypeTable path="../../packages/api-schemas/src/objectives.ts" name="ConditionSpec" />

### ConditionCheck

<AutoTypeTable path="../../packages/api-schemas/src/objectives.ts" name="ConditionCheck" />
